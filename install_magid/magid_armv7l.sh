#!/bin/bash
#This script installs magid for armv7l on your device.
...
cd ..
make -f makefile.unix xCPUARCH=armv7l CXXFLAGS='-I /opt/local/db-4.8.30.NC/include -L /opt/local/db-4.8.30.NC/lib'
