#!/bin/bash
#This script installs magid for amd64 (x86_64) on your device.
...
cd ..
make -f makefile.unix xCPUARCH=x86_64 CXXFLAGS='-I /opt/local/db-4.8.30.NC/include -L /opt/local/db-4.8.30.NC/lib'
